...
1. 畫面可以選擇Excel檔案，要可以變成抓取使用者選擇的檔案，並且可以清除選擇檔案的按鈕
2. 有執行按鈕，也有中斷執行的按鈕
...
Vibe Coding最怕就是撰寫新功能，結果把原本的功能給弄壞了。所以我們需要版本控制，在AI怎樣都做錯時，至少還可以返回之前的版本，所以我們需要Github來做版本控制。另外也可以利用project的功能，來做一些簡易的專案管理，以防自己做到一半，突然忘記自己之前做了什麼，或是接下來要做什麼了。

![Github project圖片]()

- 一般Vibe Coding通常用截圖給AI大多可以辨認，特別web又更好抓，只是剛好這專案我們沒有鼎新ERP原始碼，加上鼎新ERP系統用舊式技術架構，較難抓取元件，所以我們需要更多的描述以及名詞的統一，讓AI可以理解我們的需求，提示詞有些地方也用更程式化的方式撰寫，確保AI有照著我們意思寫。若比較沒有程式概念，也是可以嘗試截圖整個視窗給AI，讓AI幫你分析這個視窗的結構，讓他告訴你，他到底抓得到哪些元件等等。
